...
class NoirTheme : public BaseTheme {
 public:
  // Component drawing methods
  void fillBatteryIcon(const GfxRenderer& renderer, Rect rect, uint16_t percentage) const override;
  // BaseTheme does not declare this as virtual, so we omit 'override'
  void drawBatteryRight(const GfxRenderer& renderer, Rect rect, bool showPercentage) const;
  ...
  // Uses const renderer; casts internally to call BaseTheme::drawArrowIfNeeded which requires non-const
