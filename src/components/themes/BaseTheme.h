...
class BaseTheme {
 public:
  // Helper used by some theme implementations to optionally draw an arrow next to a label.
  // Returns true if the arrow was drawn (always true for this simple implementation).
  static bool drawArrowIfNeeded(GfxRenderer& renderer,
                                const char* label,
                                int x,
                                int y,
                                int size,
  ...
  virtual void drawSpinner(const GfxRenderer& renderer, int centerX, int centerY, const char* text,
                           int frame) const;
